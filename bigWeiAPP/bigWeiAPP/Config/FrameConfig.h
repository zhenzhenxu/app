...
#define YZKCalculateX(x)        ((x) * SCREEN_WIDTH / APP_WIDTH)
#define YZKCalculateY(y)        ((y) * SCREEN_WIDTH / APP_WIDTH)
#define YZKRecoverX(x)          ((x) * APP_WIDTH / SCREEN_WIDTH)
#define YZKRecoverY(y)          ((y) * APP_WIDTH / SCREEN_WIDTH)
